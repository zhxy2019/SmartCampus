...
<script type="text/javascript">
    function ajaxShowKnowledgeGraph(studentId,studentname, courseId,coursename) {
        ...
        var getReasonListUrl = basepath + 'counselor/getReasonList';
    ...
    $(document).ready(function (e) {
        ...
        function ajaxShowAlertData(){
            ...
            //ajax获取挂科百分比
            var getAlertDataUrl = basepath + 'counselor/getAlertPercentage';
            $.ajax({
                url: getAlertDataUrl,
                async: true,
                cache: false,
        ...
        function ajaxGetPredictResult(){
            ...
            var predictScoreListTable = $('#predictStudentList').DataTable({
                ...
                ajax: {
                    type: "post",
                    url: basepath + "counselor/getPredictStudentList",
                    async: true,
                    cache: true,
                    dataType: "json",
        ...
        function ajaxShowStudentDetail(studentInfo) {
            ...
            var getPredictCourseUrl = basepath + 'counselor/getPredictCourse';
        ...
        //显示所管理学生可能挂科的占比
        ajaxShowAlertData();
        ajaxGetPredictResult();
        //post 请求数据，在校生人数、有留级风险人数
        var getMenuDataUrl=basepath+'counselor/getMenuData';
        $.ajax({
            url: getMenuDataUrl,
            async: true,
            cache: false,
